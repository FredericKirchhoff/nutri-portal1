      ...
      <v-col cols="12" md="8">
            ...
            <v-row class="d-flex justify-center white--text text-h6">
              <v-tooltip bottom color="#614021">
                <template v-slot:activator="{ on, attrs }">
                  <v-card class="ma-4" height="350" width="250">
                    <v-img
                      src="https://www.linkpicture.com/q/hevoise_ok.png"
                      height="100%"
                    >
                      <v-row class="text-h6 ml-4 mr-1 mt-2 white--text">
                        {{ course.prof }}
                ...
                <span>
                  <v-row class="d-flex justify-center text-subtitle-1">
                    Nutricionista pela Universidade do Vale do Rio dos Sinos –
                    UNISINOS (RS). <br />
                    Mestrado pela Disciplina de Nefrologia (UNIFESP) e Mentora
                    em nutrição Renal.
                  </v-row>
                </span>
              </v-tooltip>
        ...
        <v-row>
          ...
          >
            <v-row class="d-flex justify-center text-h6 white--text">
              O curso tem como objetivo capacitar os nutricionistas para o
              atendimento de pacientes renais, abordando os seguintes conteúdos:
              <br />

              Fisiopatologia Renal <br />
        ...
        <v-row>
          <v-col
            ...
            class="d-flex justify-center text-center white--text"
          >
            <v-text class="text-h6"> Aula ao vivo do 24/08/2020 </v-text>
          </v-col>
        </v-row>
      </v-col>
      <v-col cols="0" md="2"></v-col>
  ...
  methods: {
    acquireCourse() {
      this.$store.dispatch("userAcquireCourse", {
        descrShort: "Aprenda com quem é referência nacional na área!",
        imgUrl: "https://www.linkpicture.com/q/nutricaorenal.png",
        courseId: "NutricaoRenal",
        course: "Nutrição Renal",
        price: 60,
        linkCurso: "Curso-Nurticao-renal" 
