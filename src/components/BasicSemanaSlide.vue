      ...
      <v-col cols="12" md="8">
        ...
        <v-row>
          <v-col cols="12" md="4" class="d-flex justify-center">
            <v-card class="ma-4" height="350" width="250">
              <v-img :src="course.imgUrl" height="100%"></v-img>
            </v-card>
          </v-col>
          <v-col
            cols="12"
              ...
              <v-tooltip bottom color="#614021">
                ...
                <span>
                  <v-row class="d-flex justify-center text-subtitle-1">
                    Hevoise Papini <br />
                    Thayana Albuquerque Kirchhoff <br />
                    Fernanda Navarro <br />
                    Tayana Vago <br />
                    Viviane Anastácio <br />
                    Francine Schütz <br />
                    Joyce Quenca
                  </v-row>
                </span>
        ...
        <v-row>
          <v-col
            ...
            class="d-flex justify-center text-center white--text"
          >
            <v-row class="d-flex justify-center text-h5 white--text">
              Palestras dia 1: Atendimento Nutricional após a pandemia <br />
              Palestras dia 2: Mindful Eating / Microbioma Intestinal /
              Fitoativos no Esporte e Longevidade<br />
              Palestras dia 3: Microbioma e Câncer / Síndrome Fúngica /
              Hipersensibillidade Alimentar<br />
              Mini-curso internacional: Nutrigenética e Nutrigenômica <br />
              Mini-curso internacional: Prescrição de Probióticos e Parabióticos
              na Imunidade, Constipação e Alterações Comportamentais <br />
              Mini-curso: Modulação em Epigenética e Bioenergética Mitocondrial
              <br />
              Bônus: Curso de Atendimento Nutricional na COVID19
            </v-row>
          </v-col>
        </v-row>
        <v-row>
          ...
          >
            <v-text class="text-h6 white--text">
  ...
  methods: {
    acquireCourse() {
      this.$store.dispatch("userAcquireCourse", {
        descrShort: " ",
        imgUrl: "https://www.linkpicture.com/q/semana_1.png",
        courseId: "PacoteBASICSemana",
        course: "Pacote Semana do Nutricionista",
        price: 155,
        linkCurso: "Curso-Basic-semana" 
