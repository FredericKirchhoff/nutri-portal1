      ...
      <v-col cols="12" md="8">
        ...
        <v-row>
          ...
          >
            <v-row class="d-flex justify-center white--text text-h6">
              <v-card class="ma-4" height="350" width="250">
                <v-img
                  src="https://www.linkpicture.com/q/tayana_vago.png"
                  height="100%"
                >
                  <v-row class="text-h6 ml-4 mr-1 mt-2 white--text">
                    {{ course.prof }}
        ...
        <v-row>
          ...
          >
            <v-text class="text-h6 white--text">
              O curso proporcionará ao nutricionista habilidades
              teórico-práticas para o atendimento de atletas e desportivas na
              abordagem da nutrição funcional, objetivando a melhora do
              desempenho
            </v-text>
          </v-col>
        </v-row>
        <v-row>
          ...
          >
            <v-text class="text-h6 white--text">
              Topicos: <br />
              - Bases da nutrição esportiva funcional <br />
              - Macronutrientes no esporte: recomendações e evidências <br />
              - Suplementos para melhora da performance no endurance e
        ...
        <v-row>
          <v-col
            ...
            class="d-flex justify-center text-center white--text"
          >
            <v-text class="text-h6"> Aula ao vivo do 31/08/2020 </v-text>
          </v-col>
        </v-row>
      </v-col>
      <v-col cols="0" md="2"></v-col>
  ...
  methods: {
    acquireCourse() {
      this.$store.dispatch("userAcquireCourse", {
        descrShort: "Estratégias de Otimização de Performance no Endurance e Treino de Força",
        imgUrl: "https://www.linkpicture.com/q/nutricaoesportiva.png",
        courseId: "NutricaoEsportiva",
        course: "Nutrição Esportiva Funcional",
        price: 60,
        linkCurso: "Curso-Nutricao-esportiva" 
