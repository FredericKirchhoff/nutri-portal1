            ...
            <v-row class="d-flex justify-center white--text text-h6">
              <v-tooltip bottom color="#614021">
                <template v-slot:activator="{ on, attrs }">
                  <v-card class="ma-4" height="350" width="250">
                    <v-img
                      src="https://www.linkpicture.com/q/joao2_1.png"
                      height="100%"
                    >
                      <v-row class="text-h6 ml-4 mr-1 mt-2 white--text">
                        {{ course.prof }}
                ...
                <span>
                  <v-row class="d-felx justify-center text-subtitle-1">
                    - Mestrando em ciências da Cardiologia pela Escola Paulista
                    de - Medicina da Universidade Federal de São Paulo –
                    EPM/UNIFESP
                    <br />
                    - Especialista em Nutrição Esportiva (FAPES) e Mindfulness
                    (UNIFESP) <br />
                    - Instrutor em Mindfulness, em Mindful Eating pelos
                    protocolos MB-EAT, MBES e ME-CL. <br />
                    - Instrutor em Treinamento de Autocompaixão (CMSC) <br />
                    - Assessor Científico do departamento de Nutrição da
                    Sociedade de Cardiologia do Estado de São Paulo (SOCESP)
                    <br />
                    - Professor convidado de Pós Graduação para as temáticas de
        ...
        <v-row>
          ...
          >
            <v-row class="text-h6 white--text">
              Trabalhar através do manejo comportamental se faz cada vez mais
              importante, porém, como faze-lo? Mindful Eating se mostra uma
              forma efetiva de compreender o comportamento do indivíduo bem como
              para maneja-lo. Neste minicurso você entenderá o que é Mindful
              Eating e sua base o Mindfulness. Entenderá mais afundo os
              programas de Mindful Eating e seus benefícios na promoção do
              comportamento alimentar adequado bem como seus mecanismos!
            </v-row>
          </v-col>
        </v-row>
        <v-row>
  ...
  methods: {
    acquireCourse() {
      this.$store.dispatch("userAcquireCourse", {
        descrShort: "Estimule mudanças no comportamento alimentar do seu paciente",
        imgUrl: "https://www.linkpicture.com/q/mindfuleating.png",
        courseId: "MindfulEating",
        course: "Mindful Eating",
        price: 60,
        linkCurso: "Curso-Mindful-eating" 
