        ...
        <v-row>
          ...
          >
            <v-row class="d-flex justify-center white--text text-h6">
              <v-card class="ma-4" height="350" width="250">
                <v-img
                  src="https://www.linkpicture.com/q/taciana_ok1.png"
                  height="100%"
                >
                  <v-row class="text-h6 ml-4 mr-1 mt-2 white--text">
                    {{ course.prof }}
        ...
        <v-row>
          ...
          >
            <v-row class="text-h6 white--text">
              Este mini curso é totalmente prático e as receitas funcional são
              preparadas ao vivo pelo Personal Cook Taciana Amim.
            </v-row>
          </v-col>
        </v-row>
        <v-row>
        ...
        <v-row>
          ...
          >
            <v-text class="text-h6">
              Aula ao vivo do 05/09/2020, parte 1
            </v-text>
          </v-col>
        </v-row>
        <v-row>
          ...
          >
            <v-text class="text-h6">
              Aula ao vivo do 05/09/2020, parte 2
            </v-text>
          </v-col>
        </v-row>
      </v-col>
  ...
  methods: {
    acquireCourse() {
      this.$store.dispatch("userAcquireCourse", {
        descrShort: "Aprenda deliciosos bolos para encantar seus pacientes",
        imgUrl: "https://www.linkpicture.com/q/confeitariafuncional.png",
        courseId: "ConfeitariaFuncional",
        course: "Confeitaria funcional",
        price: 60,
        linkCurso: "Curso-Confeitaria-funcional" 
