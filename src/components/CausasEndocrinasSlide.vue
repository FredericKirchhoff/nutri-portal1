        ...
        <v-row>
          ...
          >
            <v-row class="d-flex justify-center white--text text-h6">
              <v-card class="ma-4" height="350" width="250">
                <v-img
                  src="https://www.linkpicture.com/q/profnatashavilanova.png"
                  height="100%"
                >
                  <v-row class="text-h6 ml-4 mr-1 mt-2 white--text">
                    {{ course.prof }}
                  ...
                  <v-card-subtitle class="white--text">
                    Médica - Especialista em Endocrologia
                  </v-card-subtitle>
                </v-img>
              </v-card>
            </v-row>
        ...
        <v-row>
          ...
          >
            <v-row class="text-h6 white--text">
              Um dos desafios no Consultório do nutricionista é a abordagem
              quanto ao emagrecimento do seu paciente. Por mais que ele mantenha
              a adesão à dieta prescrita , você profissional deve saber
              identificar se existe alguma causa secundária ao processo de ganho
              de peso ! Através do curso você irá identificar as principais
              causas hormonais da obesidade e desmistificar alguns mitos
