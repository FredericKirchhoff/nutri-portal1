    ...
    <div>
        <v-row class="d-flex justify-center">
            ...
            <v-card width="100%" v-show="state.isAuthenticated" elevation="0">
                ...
                ><div data-plyr-provider="youtube" data-plyr-embed-id="GNIx2CepxsI"></div>
                </vue-plyr>
            </v-card>
                </v-row>
            </v-col>
...
//   },
  methods: {
    playerReady () {
      this.player.currentTime = Math.round(this.aula.progress / 100 * 6606);
    },
    setProgress() {
        this.$store.dispatch("setProgressBar", {
          progress: Math.round(this.player.currentTime / 6606 * 100),
          course: "NutricaoEsportiva",
          aula: "aula1"
        })
    }
  }
